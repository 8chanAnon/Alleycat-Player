...
This project has been fraught with CORS issues since the beginning. Due to the number of sites now being supported (about 50), it has become necessary to provide a Local Proxy Server to bypass the CORS issues. The code for the proxy server is available at the home repository (which I have indicated above) but I am not planning to place that code here.

I am uploading this project to GitHub in order to get more eyeballs on the project. There is only so much I can do alone. Comments and suggestion will be much appreciated.

P.S. I am a noob on GitHub so I may be doing some things wrong. :)
